...
# (project=scitex-sh, owner=ywatanabe1989, repo=scitex-sh,
...
TMPDIR="/tmp/publish-scitex_sh-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-sh dist/* uploaded to PyPI via manual OIDC trusted publishing"
